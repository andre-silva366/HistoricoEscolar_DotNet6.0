...
namespace HistoricoEscolar.Migrations
{
    ...
    [Migration("20231013222155_CriacaoDaTabela6")]
    partial class CriacaoDaTabela6
    {
            ...
            modelBuilder.Entity("HistoricoEscolar.Models.Historico", b =>
                {
                    ...
                    b.Property<int?>("AlunoMatriculaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HistoricoEscolar.Models.Historico", b =>
                {
                    b.HasOne("HistoricoEscolar.Models.Aluno", "Aluno")
                        .WithMany()
                        .HasForeignKey("AlunoMatriculaId");
